...
VALUES
    (
        ...
        '2025-01-01',
        NULL,
        'Multa padrão para atraso na devolução'
    ),
    (
        1.50,
        '2024-01-01',
        '2024-12-31',
        'Multa vigente em 2024'
    ),
    (
        3.00,
        '2025-06-01',
        NULL,
        'Multa aumentada devido à inflação'
    );
...
VALUES
    ...
    (
        '2023003',
        'pedro.oliveira@academico.edu.br',
        'hash_senha_003',
        'Pedro Oliveira',
        'aluno',
        'ativo',
    ...
    (
        'PROF001',
        'carlos.mendes@academico.edu.br',
        'hash_senha_101',
        'Carlos Mendes',
        'professor',
        'ativo',
    ...
    (
        'PROF002',
        'juliana.fernandes@academico.edu.br',
        'hash_senha_102',
        'Juliana Fernandes',
        'professor',
        'ativo',
    ...
    (
        'ADM001',
        'admin.sistema@academico.edu.br',
        'hash_senha_201',
    ...
    (
        'ADM002',
        'supervisor.biblio@academico.edu.br',
        'hash_senha_202',
...
VALUES
    -- Empréstimos ativos
    ('2025-09-10', '2025-09-24', NULL, 'ativo', 2, 1),
    ('2025-09-12', '2025-09-26', NULL, 'ativo', 7, 2),
    ('2025-09-15', '2025-09-29', NULL, 'ativo', 10, 3),
...
VALUES
    ...
    -- Multa pendente (em atraso - 20 dias)
    (
        4,
        5.00,
        5.00,
